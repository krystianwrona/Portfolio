                ...
                >
                  ...
                  >
                    <Image
                      ...
                      style={{ width: "auto", height: "100%", maxWidth: "100%", objectFit: "contain", display: "block", margin: "0 auto", borderRadius: "12px", ...(slide.type === "flat" ? { transform: "scale(1.125)", transformOrigin: "center center" } : {}) }}
                      draggable={false}
                    />
                  </div>
                </div>
